...
function getFourDigitTokenFromSession(intent, session, callback) {
  ...
  speechOutput = "Your four digit token is 4, 3, 9, 6. " +
    "Please enter this token at www.ReadingBot.co.uk. ";
...
function onIntent(intentRequest, session, callback) {
  ...
  if (intentName === 'WhatsMyFourDigitTokenIntent') {
    getFourDigitTokenFromSession(intent, session, callback);
